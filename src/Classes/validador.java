...
public class validador {
    ...
    private void validadorCPF() {
        ...
        for (int ab = 0, abc = 9; ab <= 8;) {
            /*
             * Pegando o algarismo e o peso de cadas posição multiplicando e armazenando o
             * valor no validador 1 ( 1 a 9)
             */
